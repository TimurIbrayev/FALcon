...
parser.add_argument('--output_path',default='results/DDT/CUB/Projection/VGG16-448',dest='output_path')
...
for class_ind in range(200):
    ...
    with torch.no_grad():
        ...
        print("Class: {}, trainval cnt files: {}".format(class_ind, len(now_class_dict)))
        ...
        for k, v in now_class_dict.items():
            ...
            cnt +=1
            if cnt < 10:
                savepath = 'results/DDT/CUB/Visualization/VGG16-vis-test/%s' % cls
